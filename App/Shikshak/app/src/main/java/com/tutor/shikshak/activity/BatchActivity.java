...
public class BatchActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private EditText batch_name, batch_subject, batch_time, batch_fees;
    private String coachingB, batchB, subjectB, timeB, feesB;
    private Button buttonBatch;
    private Spinner coaching_spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        batch_subject = (EditText) findViewById(R.id.subject);
    ...
    public void onClick(View v) {
        ...
        subjectB = batch_subject.getText().toString();
